<%@ Page Title="" Language="C#" MasterPageFile="~/UserSite.Master" AutoEventWireup="true" CodeBehind="UserViewRestaurantReview.aspx.cs" Inherits="FDSApplication.UserViewRestaurantReview" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-md-8 mt-3">
        ...
        <p>
            View All Restaurant Review Over Here</p>
        <br />
