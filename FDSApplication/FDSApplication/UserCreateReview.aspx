<%@ Page Title="" Language="C#" MasterPageFile="~/UserSite.Master" AutoEventWireup="true" CodeBehind="UserCreateReview.aspx.cs" Inherits="FDSApplication.UserCreateReview" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-md-8 mt-2">
        <h3>Create Review</h3>
        <p>Write your review over here</p>
            ...
            <div class="row">
                <div class="col">
                    <div class="form-group">
                        ...
                        <br />
                        <asp:TextBox ID="txtReview" runat="server" Height="150px" MaxLength="500" TextMode="MultiLine" CssClass="form-control"></asp:TextBox>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <br />
                        <asp:DropDownList ID="ddlRestaurantRating" runat="server" CssClass="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <br />
                        <asp:DropDownList ID="ddlRiderRating" CssClass="form-control" runat="server">
                            <asp:ListItem>5</asp:ListItem>
                            <asp:ListItem>4</asp:ListItem>
                            <asp:ListItem>3</asp:ListItem>
                            <asp:ListItem>2</asp:ListItem>
